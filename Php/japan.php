...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    ...
    <!-- Hero Section -->
    <!-- Hero Section -->
<section class="relative w-full h-96 flex items-center justify-center bg-cover bg-center" style="background-image: url('images/japanhome.jpg')">
    <div class="absolute inset-0 bg-black bg-opacity-40"></div>
    <div class="relative text-center text-white p-8 max-w-3xl mx-auto">
        <h2 class="text-5xl md:text-6xl font-extrabold font-display mb-2 text-shadow">Japan</h2>
        <p class="text-xl md:text-2xl mt-4 mb-8">Land of the Rising Sun – where tradition and technology unite</p>
    </div>
</section>
...
<section class="py-8 bg-white dark:bg-gray-800">
    <div class="container mx-auto px-6">
        <div class="flex flex-wrap justify-center gap-6 text-center">
            ...
            <div class="flex items-center">
                <i class="fas fa-language text-red-500 text-xl mr-2"></i>
                <span>Japanese</span>
            </div>
            <div class="flex items-center">
                <i class="fas fa-yen-sign text-red-500 text-xl mr-2"></i>
                <span>Japanese Yen (JPY)</span>
            </div>
            <div class="flex items-center">
                <i class="fas fa-leaf text-red-500 text-xl mr-2"></i>
                <span>Temperate</span>
            </div>
        </div>
    </div>
...
<section class="py-12 px-6">
    <div class="container mx-auto max-w-4xl">
        <div class="mb-12">
            <h2 class="text-3xl font-bold mb-6 font-display">Experience Japan's Wonders</h2>
            <p class="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                Japan is a unique blend of ancient traditions and cutting-edge innovation. From serene temples and cherry blossoms to neon-lit cities and bullet trains, Japan promises an unforgettable journey through culture, cuisine, and contrast.
            </p>

            <div class="bg-red-100 dark:bg-red-900 rounded-lg p-6 mb-8 relative">
                ...
                <p>In Japan, there are vending machines for almost everything—from hot ramen and fresh eggs to umbrellas and books. You'll find one on nearly every street corner!</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                <div class="h-48 bg-gray-300 overflow-hidden">
                    <img src="images/mount.jpg" alt="Mount Fuji" class="w-full h-full object-cover transition duration-300 hover:scale-110">
                </div>
                <div class="p-4">
                    ...
                    <h3 class="text-xl font-semibold mb-2">Mount Fuji</h3>
                    <p class="text-gray-600 dark:text-gray-400">Climb Japan’s iconic snow-capped peak or enjoy breathtaking views from nearby lakes and hot springs.</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                <div class="h-48 bg-gray-300 overflow-hidden">
                    <img src="images/kyoto.jpg" alt="Kyoto Temples" class="w-full h-full object-cover transition duration-300 hover:scale-110">
                </div>
                <div class="p-4">
                    ...
                    <h3 class="text-xl font-semibold mb-2">Kyoto Temples</h3>
                    <p class="text-gray-600 dark:text-gray-400">Step into the past with a visit to Kyoto’s stunning temples, shrines, and historic geisha districts.</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                <div class="h-48 bg-gray-300 overflow-hidden">
                    <img src="images/japanfood.jpg" alt="Japanese Cuisine" class="w-full h-full object-cover transition duration-300 hover:scale-110">
                </div>
                <div class="p-4">
                    ...
                    <h3 class="text-xl font-semibold mb-2">Japanese Cuisine</h3>
                    <p class="text-gray-600 dark:text-gray-400">From sushi and ramen to street snacks and tea ceremonies, savor the delicious diversity of Japan’s culinary scene.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-700 dark:text-gray-300">Pack comfortable shoes, weather-appropriate layers, and conservative attire for shrines and temples.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-700 dark:text-gray-300">Sushi, Ramen, Okonomiyaki, Tempura, and traditional matcha desserts are must-tries.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-700 dark:text-gray-300">Use Japan Rail Pass for bullet trains, local metros, or rent a bike for smaller towns and scenic spots.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-700 dark:text-gray-300">Bowing is a common greeting, shoes should be removed indoors, and silence is appreciated on public transport.</p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Call to Action -->
<section class="py-16 px-6 bg-cover bg-center relative" style="background-image: url('images/japan-cta.jpg')">
    <div class="absolute inset-0 bg-blue-900 bg-opacity-80"></div>
    <div class="container mx-auto relative z-10">
        <div class="max-w-2xl mx-auto text-center text-white">
            <h2 class="text-4xl font-bold mb-4 font-display">Ready for your Japan adventure?</h2>
            <p class="text-xl mb-8">From futuristic cities to timeless temples—Japan awaits!</p>
...
<section class="py-12 px-6 bg-yellow-100 dark:bg-yellow-900">
    <div class="container mx-auto max-w-4xl text-center">
        ...
        <blockquote class="text-2xl italic font-display mb-4">"Japan isn’t just a destination—it’s a journey into the future wrapped in timeless tradition."</blockquote>
